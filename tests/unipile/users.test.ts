...
const USER_IDENTIFIER_TO_GET = 'some-linkedin-public-identifier';
const USER_SEARCH_KEYWORDS = 'Software Engineer';
const INVITATION_RECIPIENT_ID = 'linkedin-profile-urn'; // e.g., "urn:li:fs_profile:ACoAABC..."
const INVITATION_MESSAGE = 'Hello, let\'s connect!';
